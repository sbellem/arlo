...
import ballotNotFound from 'action/county/ballotNotFound';
...
const BallotNotFoundForm = (props: NotFoundProps) => {
    ...
    const onClick = () => {
        if (window.confirm('By continuing, this ballot will be recorded as “not found”'
