...
import AuditBoardNumberSelector from 'component/County/Dashboard/AuditBoardNumberSelector';

import FileUploadContainer from './FileUploadContainer';

import downloadCvrsToAuditCsv from 'action/county/downloadCvrsToAuditCsv';

import fetchReport from 'action/county/fetchReport';

import FileDownloadButtons from 'component/FileDownloadButtons';
...
const AuditBoardButtons = (props: AuditBoardButtonsProps) => {
    ...
    const handleButtonClick = (e: any, boardIndex: number, hasBoard: boolean) => {
        ...
        if (hasBoard) {
          ...
          canRedirect = window.confirm(message);
        }
