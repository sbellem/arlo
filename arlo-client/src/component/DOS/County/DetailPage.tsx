...
import { formatCountyASMState } from 'format';
...
const CountyDetails = (props: DetailsProps) => {
    ...
    const auditedCount : string = _.get(status, 'discrepancyCount.audited') || '—';
    const unauditedCount : string = _.get(status, 'discrepancyCount.unaudited') || '—';
